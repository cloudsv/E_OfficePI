<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ReportHR.aspx.cs" Inherits="E_OfficePI.Page.Report.ReportHR" %>
                            ...
                            <div class="container">
                                <div class="row">
                                    <div  class="col-8" style="margin-bottom:10px;margin-top:10px;font-size:16px;">
                                        <span style="color:black;"><u>รายงานระบบบุคคล</u></span>
                                    </div>
