<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveTQF.aspx.cs" Inherits="E_OfficePI.Page.TQF.ApproveTQF" %>
...
<head>
    ...
    <link TQFef="../../js/datepicker/datepicker.css" rel="stylesheet" />
    <title></title>
    <style>
        button {
   ...
   <script>
       ...
       function ChangeApprove(userid, Approveruserid) {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/TQF/ApproveTQF.aspx/ChangeApprove",
               data: "{'json' :'" + json + "'}",
       ...
       function ChangeValidate(userid, validatoruserid) {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/TQF/ApproveTQF.aspx/ChangeValidate",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
       ...
       function Search() {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/TQF/ApproveTQF.aspx/GetApproverTQF",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
       ...
       function GetAPOrg() {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/TQF/ApproveTQF.aspx/GetAPOrg",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
...
<body>
    <input type="hidden" id="HdTQFtype" value="" />
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" style="color: black !important; font-family: TH SarabunPSK;">
                    <li class="nav-item">
                        <a class="nav-link" TQFef="#" >สายงานอนุมัติมาตรฐานอุดมศึกษา</a>
                    </li>
                </ul>
            </div>
        </nav>
   
    <div id="DivApproveTQF" style="display: none;margin-top:30px;">
        <div class="container">
            <div class="row mt-3">
            ...
            <div class="row mt-1">
                  <div id="DivApproveTQFcont" class="col-12">
