<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Forgotpassword.aspx.cs" Inherits="E_OfficePI.Forgotpassword" %>
...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="ie=edge">
     <title>E-OFFICE สถาบันพระบรมราชชนก</title>
    <!-- External CSS -->
                ...
                <div class="row login-box-12">
                    <div class="col-lg-5 col-md-12 col-sm-12 px-0">
                        <div class="login_right">
                            ...
                            <p style="font-family:TH SarabunPSK;">สถาบันพระบรมราชชนก</p>
                            <div style="text-align: center">
                                <img src="https://admission.pi.in.th/admission/document/piLogo.png" style="width: 120px;"></div>
                        </div>
                    </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" style="text-align: left!important;">
                    <h5 class="modal-title">E-OFFICE สถาบันพระบรมราชชนก</h5>
