...
namespace E_OfficePI.Printforms.rpt {
    using System;
    ...
    public class Contactmanual : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "E_OfficePI.Printforms.rpt.Contactmanual.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedContactmanual : Component, ICachedReport {
        
        public CachedContactmanual() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            Contactmanual rpt = new Contactmanual();
            rpt.Site = this.Site;
            return rpt;
        }
