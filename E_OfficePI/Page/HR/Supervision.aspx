<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Supervision.aspx.cs" Inherits="E_OfficePI.Page.HR.Supervision" %>
...
<head>
    ...
    <script>
        function Print(id) {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/Supervision.aspx/Print",
                data: "{'json' :'" + json + "'}",
        ...
        function CallBackUpload(Label, Running) {
            $.ajax({
                type: "POST",
                url: "\../Page/HR/Supervision.aspx/CallBackUpload",
        ...
        function Savecost() {
            ...
            json += 'Hdsupervisionid :' + $('#Hdsupervisionid').val() + "|";
            $.ajax({
                type: "POST",
                url: This + "/Savecost",
                data: "{'json' :'" + json + "'}",
        ...
        function Del(id) {
            ...
            $('#DivConfirmMsg').html('ต้องการที่จะลบการตั้งเรื่องไปสอนภาคปฏิบัติ ?');
            $('#CmdConfirm').on('click', function () {
                json = id;
                $.ajax({
                    type: "POST",
                    url: "\../Page/HR/supervision.aspx/Del",
                    data: "{'json' :'" + json + "'}",
                    contentType: "application/json; charset=utf-8",
                    dataType: "json",
                    success: function (response) {
        ...
        function Detail(id) {
            ...
            var html = '';
            var i = 0;
            $('#Hdsupervisionid').val(id);
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Detail",
                data: "{'json' :'" + id + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Getrequest() {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getrequest",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Save() {
            var json = '';
            $("#Divnewsupervision").find('textarea').each(function () {
                    json += $(this).attr('id') + ':' + $(this).val() + "|";
                
            });
            $("#Divnewsupervision").find('select').each(function () {

                json += $(this).attr('id') + ':' + $(this).val() + "|";

            });
            $("#Divnewsupervision").find('input[type = text]').each(function () {

                json += $(this).attr('id') + ':' + $(this).val() + "|";

            });
            $("#Divnewsupervision").find('input[type = checkbox]').each(function () {
        ...
        function Getsupervisiontype() {
            var json = '';
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getsupervisiontype",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
                ...
                success: function (response) {
                    res = response.d;
                    $('#Cbsupervisiontypeid').find('option').remove().end();

                    if (res.length == 0) {
                        $('#Cbsupervisiontypeid').append($('<option/>', {
                            value: '',
                            text: 'ไม่พบข้อมูล'
                        }));
                    }
        ...
        function Getorg() {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getorg",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Getvehicletype() {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getvehicletype",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Getdeveloptype() {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getdeveloptype",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Getcountry() {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getcountry",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Getprovince() {
            ...
            $.ajax({
                type: "POST",
                url: "\../Page/HR/supervision.aspx/Getprovince",
                data: "{'json' :'" + json + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                beforeSend: function () {
        ...
        function Bindsupervision() {

            ClearResource('HR/supervision.aspx', 'Gvsupervision');
            var Cri = $('#Hdsupervisionid').val();
            var Columns = ["เลขที่เอกสาร!L", "วันที่ออกเอกสาร!L", "เรื่อง!L", "ไปสอนภาคปฏิบัติ!L", "สถานที่!L", "ค่าใช้จ่าย!C", "!C", "!C"];
            var Data = ["Docno", "Documentdate", "supervisionname", "duration", "Place", "Detail", "Del", "Print"];
            var Searchcolumns = ["supervisionname"];
            var SearchesDat = ["supervisionname"];
            var Width = ["10%", "10%", "20%", "20%", "15%", "10%", "5%", "5%"];
            var Gv = new Grid("HR/supervision.aspx", Columns, SearchesDat, Searchcolumns, 'Gvsupervision', 30, Width, Data, "", '', '', '', '', '', '', '', '', 'id', '', '', 'id', Cri, '');
            $('#Divsupervisioncont').html(Gv._Tables());
            Gv._Bind();
        }
        $(function () {
...
<body>
    ...
    <div class="container-fluid" style="font-family: TH SarabunPSK; background-color: white; padding: 10px; width: 100%; margin-top: 20px;">
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" style="color: black !important; font-family: TH SarabunPSK;">
                    <li class="nav-item">
                        <a class="nav-link" href="#" onclick="supervision();">การไปสอนภาคปฏิบัติ</a>
                    </li>
                </ul>
            </div>
        </nav>
        <div id="Divsupervision" style="display: none;">
            ...
            <div class="container">
                <div class="row mt-3">
                    <div class="col-12">
                        <button class="btn btn-secondary" onclick="Newsupervision();">เพิ่มการไปสอนภาคปฏิบัติ</button>
                    </div>
                </div>
                <div class="row mt-3">
                    <div class="col-12">
                        <div id="Divsupervisioncont">
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="modal fade" id="Divcost" data-backdrop="static" data-keyboard="false">
       ...
       <div class="modal fade bd-example-modal-xl"  id="Divnewsupervision" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                <div class="modal-header"  style="margin-left:100px;">
                    <span>สอนภาคปฏิบัติ</span>
                </div>
                <!-- Modal body -->
                <div class="modal-body"  style="margin-left:100px;">
                    <div class="container-fluid">
                        ...
                        <div class="row mt-1">
                         ...
                         <div class="row mt-1">
                            <div class="col-2"  style="text-align:right;">
                               <span>เรื่องสอนภาคปฏิบัติ</span>
                            </div>
                            <div class="col-10">
                                <input type="text" class="form-control" id="TxtSupervisionname" data-value="" value=""   />
                            </div>
                        </div>
                        <div class="row mt-1">
                            <div class="col-2"  style="text-align:right;">
                               <span>วันที่สอนภาคปฏิบัติ</span>
                            </div>
                            <div class="col-5">
                        ...
                        <div class="row mt-1">
                            ...
                            <div class="col-5">
                             ...
                             <div class="col-2"  style="text-align:right;">
                               <span>ประเภทการสอนภาคปฏิบัติ</span>
                            </div>
                            <div class="col-3">
                                <select class="form-control" id="Cbsupervisiontypeid"></select>
                            </div>
    ...
    <input type="hidden" id="Hdsupervisionid" value="" />
</body>
</html>