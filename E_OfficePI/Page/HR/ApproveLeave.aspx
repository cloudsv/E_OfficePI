<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveLeave.aspx.cs" Inherits="E_OfficePI.Page.HR.ApproveLeave" %>
...
<head>
   ...
   <script>
       ...
       function ChangeApprove(userid, Approveruserid) {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/Approveleave.aspx/ChangeApprove",
               data: "{'json' :'" + json + "'}",
       ...
       function ChangeValidate(userid, validatoruserid) {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/Approveleave.aspx/ChangeValidate",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
       ...
       function Search() {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/Approveleave.aspx/GetApproverleave",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
       ...
       function GetAPOrg() {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/Approveleave.aspx/GetAPOrg",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" style="color: black !important; font-family: TH SarabunPSK;">
                    <li class="nav-item">
                        <a class="nav-link" href="#" >สายงานอนุมัติการลา</a>
                    </li>
                </ul>
            </div>
        </nav>
   
    <div id="DivApproveleave" style="display: none;margin-top:30px;">
        <div class="container">
            <div class="row mt-3">
            ...
            <div class="row mt-1">
                  <div id="DivApproveleavecont" class="col-12">
