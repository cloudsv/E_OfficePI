<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ApproveOfficialvisit.aspx.cs" Inherits="E_OfficePI.Page.HR.ApproveOfficialvisit" %>
...
<head>
   ...
   <script>
       ...
       $(function () {
           ApproveOfficialvisit();
           setTimeout(() => {
               Unloading();
           }, 100);
           Search();
       });
       function ApproveOfficialvisit() {
           GetAPOrg();
           $('#DivApproveOfficialvisit').show();
       }
       function ChangeApprove(userid, Approveruserid) {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/ApproveOfficialvisit.aspx/ChangeApprove",
               data: "{'json' :'" + json + "'}",
       ...
       function ChangeValidate(userid, validatoruserid) {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/ApproveOfficialvisit.aspx/ChangeValidate",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
       ...
       function Search() {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/ApproveOfficialvisit.aspx/GetApproverOfficialvisit",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
               ...
               success: function (response) {
                   ...
                   html += '</table>';
                   $('#DivApproveOfficialvisitcont').html(html);
               },
               async: false,
               error: function (er) {
               }
       ...
       function GetAPOrg() {
           ...
           $.ajax({
               type: "POST",
               url: "\../Page/HR/ApproveOfficialvisit.aspx/GetAPOrg",
               data: "{'json' :'" + json + "'}",
               contentType: "application/json; charset=utf-8",
               dataType: "json",
               beforeSend: function () {
...
<body>
    <input type="hidden" id="HdOfficialvisittype" value="" />
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-light">
            ...
            <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav" style="color: black !important; font-family: TH SarabunPSK;">
                    <li class="nav-item">
                        <a class="nav-link" href="#" >สายงานอนุมัติการไปราชการ</a>
                    </li>
                </ul>
            </div>
        </nav>
   
    <div id="DivApproveOfficialvisit" style="display: none;margin-top:30px;">
        <div class="container">
            <div class="row mt-3">
            ...
            <div class="row mt-1">
                  <div id="DivApproveOfficialvisitcont" class="col-12">
