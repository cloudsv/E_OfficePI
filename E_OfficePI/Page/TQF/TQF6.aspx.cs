...
{
    public partial class TQF6 : System.Web.UI.Page
    {
        ...
        {
            string comment = "";
            string sqlcmd = "Select * from Sys_TQF_TQF6 where id = '" + json + "'";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
        ...
        public static string Doapprove(string json)
        {
            ...
            {
                sqlcmd = "Update Sys_TQF_TQF6 Set Status ='V',Statusname='รออนุมัติ',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            else if (ClsEngine.FindValue(Dicts, "Hdapprove") == "A")
            {
                sqlcmd = "Update Sys_TQF_TQF6 Set Status ='A',Statusname='อนุมัติแล้ว',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
        ...
        public static string Doreject(string json)
        {
            ...
            sqlcmd = "Update Sys_TQF_TQF6 Set Status ='R',Statusname='ปฏิเสธ',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static string Doedit(string json)
        {
            ...
            if (ClsEngine.FindValue(Dicts, "Hdapprove") == "V")
            {
                sqlcmd = "Update Sys_TQF_TQF6 Set Status ='',Statusname='',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            else if (ClsEngine.FindValue(Dicts, "Hdapprove") == "A")
            {
                sqlcmd = "Update Sys_TQF_TQF6 Set Status ='W',Statusname='รอตรวจสอบ',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            cn.Execute(sqlcmd, null);
            return "";
        }
        ...
        public static string Send2validate(string json)
        {
            ...
            sqlcmd = "Update Sys_TQF_TQF6 Set Comment='', Status ='W',Statusname='รอตรวจสอบ',Validateuserid='" + Dt.Rows[0]["Validatoruserid"].ToString() + "',Approveuserid='" + Dt.Rows[0]["Approveruserid"].ToString() + "' Where Id ='" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static string DelTQF(string json)
        {
            ...
            string id = "";
            id = json;
            sqlcmd = "Update [Sys_TQF_TQF6] Set IsDelete=1,DeleteDate='" + DateTime.Now + "',DeleteBy='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id='" + id + "'";
            Arrcmd.Add(sqlcmd);
        ...
        public static string Save(string json)
        {
            ...
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF6] Set ";
            ...
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF6] Set ";
                sqlcmd += "problemtraining ='" + ClsEngine.FindValue(Dicts, "Txtproblemtraining") + "'";
                sqlcmd += ",isimpactstudent ='" + ClsEngine.FindValue(Dicts, "Cbisimpactstudent") + "'";
                sqlcmd += ",adjustforaviodproblem ='" + ClsEngine.FindValue(Dicts, "Txtadjustforaviodproblem") + "'";
                sqlcmd += " Where id= '" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            else if (ClsEngine.FindValue(Dicts, "menu") == "5")
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF6] Set ";
                sqlcmd += "commentfromestimatestudent ='" + ClsEngine.FindValue(Dicts, "Txtcommentfromestimatestudent") + "'";
                sqlcmd += ",feedbackfromteacherstudent ='" + ClsEngine.FindValue(Dicts, "Txtfeedbackfromteacherstudent") + "'";
                sqlcmd += ",commentfromestimatetraining ='" + ClsEngine.FindValue(Dicts, "Txtcommentfromestimatetraining") + "'";
                sqlcmd += ",feedbackfromteachertraining ='" + ClsEngine.FindValue(Dicts, "Txtfeedbackfromteachertraining") + "'";
            ...
            else if (ClsEngine.FindValue(Dicts, "menu") == "6")
            {
                ...
                sqlcmd += ",feedbackfromtrainingtoteacher ='" + ClsEngine.FindValue(Dicts, "Txtfeedbackfromtrainingtoteacher") + "'";
                sqlcmd += " Where id= '" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            Cn.Execute(sqlcmd, null);
            return "";
        ...
        [WebMethod]
        public static ClsTQF6 LoadTQFInfo(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Select * from [Sys_TQF_TQF6] where id = '" + json + "'";
            DataTable Dt = new DataTable();
            ClsTQF6 Obj = new ClsTQF6();
            Dt = cn.Select(sqlcmd);
            if (Dt.Rows.Count == 0)
            {
            ...
            Obj.Problemtraining = Dt.Rows[0]["Problemtraining"].ToString();
            Obj.Isimpactstudent = Dt.Rows[0]["Isimpactstudent"].ToString();
            Obj.Adjustforaviodproblem = Dt.Rows[0]["Adjustforaviodproblem"].ToString();
            Obj.Commentfromestimatestudent = Dt.Rows[0]["Commentfromestimatestudent"].ToString();
            Obj.Feedbackfromteacherstudent = Dt.Rows[0]["Feedbackfromteacherstudent"].ToString();
            Obj.Commentfromestimatetraining = Dt.Rows[0]["Commentfromestimatetraining"].ToString();
            Obj.Feedbackfromteachertraining = Dt.Rows[0]["Feedbackfromteachertraining"].ToString();
            Obj.Reestimate = Dt.Rows[0]["Reestimate"].ToString();
            Obj.Improveprevioustraining = Dt.Rows[0]["Improveprevioustraining"].ToString();
            Obj.Feedbackfromtrainingtoteacher = Dt.Rows[0]["Feedbackfromtrainingtoteacher"].ToString();
            Obj.error = "";
            //Instuctor Load ใส่ Grid เอา
            return Obj;
        }
        [WebMethod]
        public static ClsTQF6 DonewTQF(string json)
        {
            ...
            sqlcmd += ",'" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "')";
            Arrcmd.Add(sqlcmd);
            sqlcmd = " INSERT INTO [Sys_TQF_TQF6] ";
            sqlcmd += " ([Id] ";
        ...
        public static ClsGridResponse Bind(string Ctrl, long PagePerItem, long CurrentPage, string SortName, string Order, string Column, string Data, string Initial, string SelectCat, string SearchMsg, string EditButton, string DeleteButton, string Panel, string FullRowSelect, string Multiselect, string Criteria, string SearchesDat, string Searchcolumns, string WPanel, string HPanel)
        {
            ...
            else if (Ctrl == "GvregisterStudent")
            {
                ...
                SqlConnector Cn = new SqlConnector(Connectionstring, null);
                Dtinfo = Cn.Select("Select * from Sys_TQF_TQF6 where isdelete = 0 and id='" + Criteria + "'");
            ...
            //{
            //    PK = "id";
            //    Sqlcmd = "Select subjectname,Generation, cast(Year as int) + 543 as year,id,Coursegroupname,Ownerorgname,Coursename,convert(nvarchar,modifydate,103) as modifydate,Statusname from sys_TQF_TQF6 where isdelete = 0 and Createby ='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "'";
            //    if (Criteria != "")
            //    {
            ...
            else if (Ctrl == "Gvsearchcourse")
            {
                ...
                string status = "";
                PK = "id";
                Sqlcmd = "Select Comment, Status,subjectname,Generation, cast(Year as int) + 543 as year, id,Coursegroupname,Ownerorgname,Coursename,convert(nvarchar,modifydate,103) as modifydate,Statusname,'' as Del,'' as Action  from sys_TQF_TQF6 where isdelete = 0 and Createby ='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "'";
                if (Criteria != "")
                {
                    Sqlcmd += " and Courseid='" + Criteria + "'";
                }
