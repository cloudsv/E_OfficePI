...
{
    public partial class TQF5 : System.Web.UI.Page
    {
        ...
        {
            string comment = "";
            string sqlcmd = "Select * from Sys_TQF_TQF5 where id = '" + json + "'";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
        ...
        public static string Doapprove(string json)
        {
            ...
            {
                sqlcmd = "Update Sys_TQF_TQF5 Set Status ='V',Statusname='รออนุมัติ',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            else if (ClsEngine.FindValue(Dicts, "Hdapprove") == "A")
            {
                sqlcmd = "Update Sys_TQF_TQF5 Set Status ='A',Statusname='อนุมัติแล้ว',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
        ...
        public static string Doreject(string json)
        {
            ...
            sqlcmd = "Update Sys_TQF_TQF5 Set Status ='R',Statusname='ปฏิเสธ',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static string Doedit(string json)
        {
            ...
            if (ClsEngine.FindValue(Dicts, "Hdapprove") == "V")
            {
                sqlcmd = "Update Sys_TQF_TQF5 Set Status ='',Statusname='',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            else if (ClsEngine.FindValue(Dicts, "Hdapprove") == "A")
            {
                sqlcmd = "Update Sys_TQF_TQF5 Set Status ='W',Statusname='รอตรวจสอบ',Comment ='" + ClsEngine.FindValue(Dicts, "Txtcomment").Replace("'", "").Replace(",", "") + "' Where Id ='" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            cn.Execute(sqlcmd, null);
            return "";
        }
        ...
        public static string Send2validate(string json)
        {
            ...
            sqlcmd = "Update Sys_TQF_TQF5 Set Comment='', Status ='W',Statusname='รอตรวจสอบ',Validateuserid='" + Dt.Rows[0]["Validatoruserid"].ToString() + "',Approveuserid='" + Dt.Rows[0]["Approveruserid"].ToString() + "' Where Id ='" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        ...
        public static string DelTQF(string json)
        {
            ...
            string id = "";
            id = json;
            sqlcmd = "Update [Sys_TQF_TQF5] Set IsDelete=1,DeleteDate='" + DateTime.Now + "',DeleteBy='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id='" + id + "'";
            Arrcmd.Add(sqlcmd);
        ...
        [WebMethod]
        public static string Newteachingoutput(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_teachingoutput", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_teachingoutput] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteteachingoutput(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_teachingoutput Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsTeachingOutput> Getteachingoutput(string json)
        {
            ClsTeachingOutput Obj;
            List<ClsTeachingOutput> Objs = new List<ClsTeachingOutput>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_teachingoutput where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsTeachingOutput();
                Obj.id = dr["Id"].ToString();
                Obj.Isbenefit = dr["Isbenefit"].ToString();
                Obj.Method = dr["Method"].ToString();
                Obj.Outputname = dr["Outputname"].ToString();
                Obj.Outputdesc = dr["Outputdesc"].ToString();
                Obj.Problem = dr["Problem"].ToString();
        ...
        [WebMethod]
        public static string Updateteachingoutput(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtteachingoutput", "");
            dat = dat.Replace("Cbteachingoutput", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            string teachingoutputid = "";
            string value = "";
            Arrcomp = dat.Split('|');
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "N") //Primary
                    {
                        teachingoutputid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Outputname";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "D") //Secondary
                    {
                        teachingoutputid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "M") //Secondary
                    {
                        teachingoutputid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "I") //Secondary
                    {
                        teachingoutputid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "P") //Secondary
                    {
                        teachingoutputid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "S") //Secondary
                    {
                        teachingoutputid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    sqlcmd = "Update Sys_TQF_teachingoutput set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + teachingoutputid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newoutline(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_outline", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_outline] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteoutline(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_outline Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<Clsoutline> Getoutline(string json)
        {
            Clsoutline Obj;
            List<Clsoutline> Objs = new List<Clsoutline>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_outline where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new Clsoutline();
                Obj.id = dr["Id"].ToString();
                Obj.Outlinename = dr["Outlinename"].ToString();
                Obj.Outlinedesc = dr["Outlinedesc"].ToString();
                Obj.Planingtotalhour = dr["PlaningTotalhour"].ToString();
                Obj.Actualhour = dr["Actualhour"].ToString();
                Obj.Actualminute = dr["Actualminute"].ToString();
                Obj.Cause = dr["Cause"].ToString();
                Objs.Add(Obj);
            }
            return Objs;
        }
        [WebMethod]
        public static string Updateoutline(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtoutline", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            ...
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "N") //Primary
                    {
                        outlineid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Outlinename";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "D") //Secondary
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "T") //Secondary
                    {
                        outlineid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();

                        field = "PlaningTotalhour";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "H") //Secondary
                    {
                        outlineid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "C") //Secondary
                    {
                        outlineid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    sqlcmd = "Update Sys_TQF_outline set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + outlineid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newproblemmanagement(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_problemmanagement", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_problemmanagement] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteproblemmanagement(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_problemmanagement Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsProblemManagement> Getproblemmanagement(string json)
        {
            ClsProblemManagement Obj;
            List<ClsProblemManagement> Objs = new List<ClsProblemManagement>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_problemmanagement where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsProblemManagement();
                Obj.id = dr["Id"].ToString();
                Obj.Impact = dr["Impact"].ToString();
                Obj.Problem = dr["Problem"].ToString();
        ...
        [WebMethod]
        public static string Updateproblemmanagement(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtproblemmanagement", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            string problemmanagementid = "";
            string value = "";
            Arrcomp = dat.Split('|');
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "I") //Primary
                    {
                        problemmanagementid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Impact";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "P") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_problemmanagement set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + problemmanagementid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newproblemlearningresource(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_problemlearningresource", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_problemlearningresource] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteproblemlearningresource(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_problemlearningresource Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsProblemLearningResource> Getproblemlearningresource(string json)
        {
            ClsProblemLearningResource Obj;
            List<ClsProblemLearningResource> Objs = new List<ClsProblemLearningResource>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_problemlearningresource where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsProblemLearningResource();
                Obj.id = dr["Id"].ToString();
                Obj.Impact = dr["Impact"].ToString();
                Obj.Problem = dr["Problem"].ToString();
        ...
        [WebMethod]
        public static string Updateproblemlearningresource(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtproblemlearningresource", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            string problemlearningresourceid = "";
            string value = "";
            Arrcomp = dat.Split('|');
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "I") //Primary
                    {
                        problemlearningresourceid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Impact";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "P") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_problemlearningresource set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + problemlearningresourceid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newverify(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_verify", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_verify] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteverify(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_verify Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsVerify> Getverify(string json)
        {
            ClsVerify Obj;
            List<ClsVerify> Objs = new List<ClsVerify>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_verify where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsVerify();
        ...
        [WebMethod]
        public static string Updateverify(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtverify", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            ...
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "M") //Primary
                    {
                        verifyid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Method";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "S") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_verify set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + verifyid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newdeviate(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_deviate", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_deviate] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deletedeviate(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_deviate Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsDeviate> Getdeviate(string json)
        {
            ClsDeviate Obj;
            List<ClsDeviate> Objs = new List<ClsDeviate>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_deviate where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsDeviate();
                ...
                Obj.Deviate = dr["Deviate"].ToString();
        ...
        [WebMethod]
        public static string Updatedeviate(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtdeviate", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            ...
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "D") //Primary
                    {
                        deviateid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Deviate";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "T") //Secondary
                    ...
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "R") //Secondary
                    {
                        deviateid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                    ...
                    sqlcmd = "Update Sys_TQF_deviate set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + deviateid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newproposal(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_proposal", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_proposal] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteproposal(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_proposal Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<Clsproposal> Getproposal(string json)
        {
            Clsproposal Obj;
            List<Clsproposal> Objs = new List<Clsproposal>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_proposal where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new Clsproposal();
                Obj.id = dr["Id"].ToString();
                Obj.Event = dr["Event"].ToString();
                Obj.Eventdue = dr["Eventdue"].ToString();
                Obj.Responsible = dr["Responsible"].ToString();
                Objs.Add(Obj);
            }
            return Objs;
        }
        [WebMethod]
        public static string Updateproposal(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtproposal", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            ...
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "E") //Primary
                    {
                        proposalid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Event";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "D") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_proposal set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + proposalid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static List<ClsTransition> Gettransition(string json)
        {
            ClsTransition Obj;
            ArrayList Arrcmd = new ArrayList();
            List<ClsTransition> Objs = new List<ClsTransition>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            DataTable Dttqf = new DataTable();
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_Transition", "Id");
            string sqlcmd = "Select * from sys_master_transition where isdelete = 0 order by cast(id as int)";
            Dt = cn.Select(sqlcmd);
            sqlcmd = "Select * from Sys_TQF_transition where isdelete = 0 and TQFId='" + json + "'";
            Dttqf = cn.Select(sqlcmd);

            foreach (DataRow dr in Dt.Rows)
            {
                if (Dttqf.Select("TransitionId ='" + dr["Id"].ToString() + "'").Length == 0)
                {

                    sqlcmd = " INSERT INTO [Sys_TQF_Transition] ";
                    sqlcmd += " ([Id] ";
                    sqlcmd += " ,[TQFId] ";
                    sqlcmd += " ,[TransitionId] ";
                    sqlcmd += " ,[IsDelete] ";
            ...
            sqlcmd = "Select d.id as id,transition,m.id as transitionid,transitiondesc,remark from Sys_Master_Transition M left join sys_tqf_transition d on m.id =d.transitionid where d.tqfid ='" + json + "'";
            Dt = new DataTable();
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsTransition();
                Obj.id = dr["Id"].ToString();
                Obj.Transition = dr["transition"].ToString();
                Obj.Transitionid = dr["Transitionid"].ToString();
                Obj.Transitiondesc = dr["Transitiondesc"].ToString();
                Obj.Remark = dr["Remark"].ToString();
                Objs.Add(Obj);
            }
            return Objs;
        ...
        [WebMethod]
        public static string Updatetransition(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txttransition", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            ...
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "D") //Primary
                    {
                        transitionid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Transitiondesc";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "R") //Secondary
                    {
                        transitionid = str.Split(':')[0].Split('_')[1].Trim();
                    ...
                    sqlcmd = "Update Sys_TQF_transition set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + transitionid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newteacherplanning(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_teacherplanning", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_teacherplanning] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deleteteacherplanning(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_teacherplanning Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsTeacherPlanning> Getteacherplanning(string json)
        {
            ClsTeacherPlanning Obj;
            List<ClsTeacherPlanning> Objs = new List<ClsTeacherPlanning>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_teacherplanning where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsTeacherPlanning();
                Obj.id = dr["Id"].ToString();
                Obj.Primaryplan = dr["Primaryplan"].ToString();
                Obj.Secondaryplan = dr["Secondaryplan"].ToString();
                Obj.Remark = dr["Remark"].ToString();
                Objs.Add(Obj);
            }
            return Objs;
        ...
        [WebMethod]
        public static string Updateteacherplanning(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtteacherplanning", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            string teacherplanningid = "";
            string value = "";
            Arrcomp = dat.Split('|');
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "P") //Primary
                    {
                        teacherplanningid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Primaryplan";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "S") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_teacherplanning set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + teacherplanningid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newcoteacherplanning(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_coteacherplanning", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_coteacherplanning] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deletecoteacherplanning(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_coteacherplanning Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsCoTeacherPlanning> Getcoteacherplanning(string json)
        {
            ClsCoTeacherPlanning Obj;
            List<ClsCoTeacherPlanning> Objs = new List<ClsCoTeacherPlanning>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_coteacherplanning where TQFId = '" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsCoTeacherPlanning();
                Obj.id = dr["Id"].ToString();
                Obj.Primaryplan = dr["Primaryplan"].ToString();
                Obj.Secondaryplan = dr["Secondaryplan"].ToString();
                Obj.Remark = dr["Remark"].ToString();
        ...
        [WebMethod]
        public static string Updatecoteacherplanning(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtcoteacherplanning", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            string coteacherplanningid = "";
            string value = "";
            Arrcomp = dat.Split('|');
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "P") //Primary
                    {
                        coteacherplanningid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Primaryplan";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "S") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_coteacherplanning set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + coteacherplanningid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        [WebMethod]
        public static string Newstudentplanning(string json)
        {
            string id = ClsEngine.GenerateRunningId(Connectionstring, "Sys_TQF_studentplanning", "id");
            string sqlcmd = "";
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            sqlcmd = " INSERT INTO  [Sys_TQF_studentplanning] ";
            sqlcmd += " ([Id]";
            sqlcmd += " ,[TQFId]";
            sqlcmd += " ,[IsDelete]";
            sqlcmd += " ,[CreateDate]";
        ...
        [WebMethod]
        public static string Deletestudentplanning(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Update Sys_TQF_studentplanning Set isdelete = 1,deletedate = getdate(),deleteby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' where id = '" + json + "'";
            cn.Execute(sqlcmd, null);
            return "";
        }
        [WebMethod]
        public static List<ClsStudentPlanning> Getstudentplanning(string json)
        {
            ClsStudentPlanning Obj;
            List<ClsStudentPlanning> Objs = new List<ClsStudentPlanning>();
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            DataTable Dt = new DataTable();
            string sqlcmd = "Select * from Sys_TQF_studentplanning where TQFId='" + json + "' and isdelete = 0 Order by id ";
            Dt = cn.Select(sqlcmd);
            foreach (DataRow dr in Dt.Rows)
            {
                Obj = new ClsStudentPlanning();
                Obj.id = dr["Id"].ToString();
                Obj.Primaryplan = dr["Primaryplan"].ToString();
                Obj.Secondaryplan = dr["Secondaryplan"].ToString();
                Obj.Remark = dr["Remark"].ToString();
        ...
        [WebMethod]
        public static string Updatestudentplanning(string json, string dat)
        {
            //TxtdevoO_1: 1 | TxtdevoD_1:2 | TxtdevoS_1:3 | TxtdevoR_1:4 | TxtdevoO_4:5 | TxtdevoD_4:6 | TxtdevoS_4:7 | TxtdevoR_4:8 |
            dat = dat.Replace("Txtstudentplanning", "");
            string sqlcmd = "";
            ArrayList Arrcmd = new ArrayList();
            string[] Arrcomp;
            string field = "";
            string studentplanningid = "";
            string value = "";
            Arrcomp = dat.Split('|');
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            foreach (string str in Arrcomp)
            {
                if (str.Trim() != "")
                {
                    if (str.Split(':')[0].Split('_')[0].Trim() == "P") //Primary
                    {
                        studentplanningid = str.Split(':')[0].Split('_')[1].Trim();
                        value = str.Split(':')[1].Trim();
                        field = "Primaryplan";
                    }
                    else if (str.Split(':')[0].Split('_')[0].Trim() == "S") //Secondary
                    ...
                    sqlcmd = "Update Sys_TQF_studentplanning set " + field + " = " + value + ",modifydate = getdate(),modifyby='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "' Where id = '" + studentplanningid + "'";
                    Arrcmd.Add(sqlcmd);
                }
            }
            cn.Execute(Arrcmd, null);
        ...
        public static List<Clstraining> Gettraining(string json)
        {
            ...
            sqlcmd = "Select Trainingid,d.id as tsid,m.Name,m.id as id from sys_tqf_trainingsource d inner join sys_master_trainingsource m on m.Id = d.Trainingsourceid where m.isdelete =0 and d.isdelete = 0 and d.tqfid = '" + json + "'";
            ...
            sqlcmd = "Select Trainingid,d.id as qaid,m.Name,m.id as id from sys_tqf_quality d inner join sys_master_quality m on m.Id = d.qualityid where m.isdelete =0 and d.isdelete = 0 and d.tqfid = '" + json + "'";
        ...
        public static string Save(string json)
        {
            ...
            if (ClsEngine.FindValue(Dicts, "menu") == "1")
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF5] Set ";
            ...
            else if (ClsEngine.FindValue(Dicts, "menu") == "2")
            {
                ...
                sqlcmd = " UPDATE [Sys_TQF_TQF5] Set ";
                sqlcmd += " Uncovetopic ='" + ClsEngine.FindValue(Dicts, "TxtUncovetopic") + "'";
                sqlcmd += ",Proposalforimprove ='" + ClsEngine.FindValue(Dicts, "TxtProposalforimprove") + "'";
                sqlcmd += " Where id= '" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
                //Do nothing
            }
            ...
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF5] Set ";
                sqlcmd += "isissueabnormalpoint ='" + ClsEngine.FindValue(Dicts, "Cbisissueabnormalpoint") + "'";
                sqlcmd += " Where id= '" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            ...
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF5] Set ";
                sqlcmd += "EstimatebyStudent ='" + ClsEngine.FindValue(Dicts, "Txtestimatebystudent") + "'";
                sqlcmd += ",TeacherRemark2EstimatebyStudent ='" + ClsEngine.FindValue(Dicts, "Txtteacherremark2estimatebystudent") + "'";
                sqlcmd += ",EstimateOther ='" + ClsEngine.FindValue(Dicts, "Txtestimateother") + "'";
                sqlcmd += ",TeacherRemark2EstimateOther ='" + ClsEngine.FindValue(Dicts, "Txtteacherremark2estimateother") + "'";
            ...
            {
                sqlcmd = " UPDATE [Sys_TQF_TQF5] Set ";
                sqlcmd += " improveprevioustraining ='" + ClsEngine.FindValue(Dicts, "Txtimproveprevioustraining") + "'";
                sqlcmd += ",improveresult ='" + ClsEngine.FindValue(Dicts, "Txtimproveresult") + "'";
                sqlcmd += ",isfeedbackfromtrainingtoteacher ='" + ClsEngine.FindValue(Dicts, "Cbisfeedbackfromtrainingtoteacher") + "'";
                sqlcmd += " Where id= '" + ClsEngine.FindValue(Dicts, "HdTQFId") + "'";
            }
            Cn.Execute(sqlcmd, null);
            return "";
        ...
        public static string Updateoutcome(string json)
        {
            ...
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            Dicts = ClsEngine.DeSerialized(json, ':', '|');
            string sqlcmd = "Update Sys_TQF_outcome set isok ='" + ClsEngine.FindValue(Dicts, "val") + "' Where id='" + ClsEngine.FindValue(Dicts, "TQFoutcomeid") + "'";
            cn.Execute(sqlcmd, null);
            return "";
        ...
        [WebMethod]
        public static ClsTQF5 LoadTQFInfo(string json)
        {
            SqlConnector cn = new SqlConnector(Connectionstring, null);
            string sqlcmd = "Select * from [Sys_TQF_TQF5] where id = '" + json + "'";
            DataTable Dt = new DataTable();
            ClsTQF5 Obj = new ClsTQF5();
            Dt = cn.Select(sqlcmd);
            if (Dt.Rows.Count == 0)
            {
            ...
            Obj.Uncovetopic = Dt.Rows[0]["Uncovetopic"].ToString();
            Obj.Proposalforimprove = Dt.Rows[0]["Proposalforimprove"].ToString();
            Obj.Isissueabnormalpoint = Dt.Rows[0]["Isissueabnormalpoint"].ToString();
            Obj.Estimatebystudent = Dt.Rows[0]["Estimatebystudent"].ToString();

            Obj.Teacherremark2estimatebystudent = Dt.Rows[0]["Teacherremark2estimatebystudent"].ToString();
            Obj.Estimateother = Dt.Rows[0]["Estimateother"].ToString();
            Obj.TeacherRemark2estimateother = Dt.Rows[0]["TeacherRemark2estimateother"].ToString();
            Obj.Other = Dt.Rows[0]["Other"].ToString();
            Obj.Previousimprove = Dt.Rows[0]["Previousimprove"].ToString();
            Obj.Improveresult = Dt.Rows[0]["Improveresult"].ToString();
            Obj.Improveprevioustraining = Dt.Rows[0]["Improveprevioustraining"].ToString();
            Obj.Isfeedbackfromtrainingtoteacher = Dt.Rows[0]["Isfeedbackfromtrainingtoteacher"].ToString();
            Obj.error = "";
            //Instuctor Load ใส่ Grid เอา
            return Obj;
        }
        [WebMethod]
        public static ClsTQF5 DonewTQF(string json)
        {
            ...
            sqlcmd += ",'" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "')";
            Arrcmd.Add(sqlcmd);
            sqlcmd = " INSERT INTO [Sys_TQF_TQF5] ";
            sqlcmd += " ([Id] ";
        ...
        public static ClsGridResponse Bind(string Ctrl, long PagePerItem, long CurrentPage, string SortName, string Order, string Column, string Data, string Initial, string SelectCat, string SearchMsg, string EditButton, string DeleteButton, string Panel, string FullRowSelect, string Multiselect, string Criteria, string SearchesDat, string Searchcolumns, string WPanel, string HPanel)
        {
            ...
            else if (Ctrl == "GvregisterStudent")
            {
                ...
                SqlConnector Cn = new SqlConnector(Connectionstring, null);
                Dtinfo = Cn.Select("Select * from Sys_TQF_TQF5 where isdelete = 0 and id='" + Criteria + "'");
            ...
            //{
            //    PK = "id";
            //    Sqlcmd = "Select subjectname,Generation,cast(Year as int) + 543 as year,id,Coursegroupname,Ownerorgname,Coursename,convert(nvarchar,modifydate,103) as modifydate,Statusname from sys_TQF_TQF5 where isdelete = 0 and Createby ='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "'";
            //    if (Criteria != "")
            //    {
            ...
            else if (Ctrl == "Gvsearchcourse")
            {
                ...
                string status = "";
                PK = "id";
                Sqlcmd = "Select Comment, Status,subjectname,Generation, cast(Year as int) + 543 as year, id,Coursegroupname,Ownerorgname,Coursename,convert(nvarchar,modifydate,103) as modifydate,Statusname,'' as Del,'' as Action  from sys_TQF_TQF5 where isdelete = 0 and Createby ='" + ((Clsuser)HttpContext.Current.Session["My"]).userid + "'";
                if (Criteria != "")
                {
                    Sqlcmd += " and Courseid='" + Criteria + "'";
                }
